...
Revision ID: 769cf211e180
Revises: 356a7dbddd3b
Create Date: 2025-05-31 20:31:16.452462
...
revision = '769cf211e180'
down_revision = '356a7dbddd3b'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('teaching', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('teaching_ibfk_2'), type_='foreignkey')
        batch_op.drop_constraint(batch_op.f('teaching_ibfk_1'), type_='foreignkey')
        batch_op.create_foreign_key(None, 'course', ['cno'], ['cno'])
        batch_op.create_foreign_key(None, 't', ['tno'], ['tno'])
...
def downgrade():
    ...
    with op.batch_alter_table('teaching', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_='foreignkey')
        batch_op.create_foreign_key(batch_op.f('teaching_ibfk_1'), 'course', ['cno'], ['Cno'])
        batch_op.create_foreign_key(batch_op.f('teaching_ibfk_2'), 't', ['tno'], ['Tno'])
